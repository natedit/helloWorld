...
class Student(db.Model):
    ...
    email = db.Column(db.String(100), nullable=False) # Addition of email field with type VARCHAR(100)
    ...
    def __init__(self, first_name, last_name, email, major_id, birth_date, is_honors):
        ...
        self.email = email # Addition of email into constructor after insertion into student table
