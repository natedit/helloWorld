...
def student_create():
    if request.method == 'GET':
        ...
        email = request.form['email'] # Additional line to request email form upon creation
        major_id = request.form['major_id']

        birth_date = request.form['birth_date']
        is_honors = True if 'is_honors' in request.form else False
        # Add email to student object
...
def student_edit(student_id):
    if request.method == 'GET':
        ...
        if student:
            ...
            student.email = request.form['email'] # Addition of email in request forms for a student edit
